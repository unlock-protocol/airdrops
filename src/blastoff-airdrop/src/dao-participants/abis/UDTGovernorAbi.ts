export const UDTGovernorAbi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "__votingDelay", type: "uint256" },
      { internalType: "uint256", name: "__votingPeriod", type: "uint256" },
      { internalType: "uint256", name: "__quorum", type: "uint256" },
      {
